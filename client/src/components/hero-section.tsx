    ...
    <section id="home" className="min-h-screen relative flex items-center justify-center mandala-bg pt-20">
      ...
      <div className="absolute inset-0 opacity-10">
        <div 
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><circle cx='50' cy='50' r='40' fill='none' stroke='%23FF9933' stroke-width='1'/><circle cx='50' cy='50' r='30' fill='none' stroke='%23DC2626' stroke-width='1'/><circle cx='50' cy='50' r='20' fill='none' stroke='%23F472B6' stroke-width='1'/></svg>")`,
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="mb-6">
              ...
              <h2 className="font-cinzel text-2xl md:text-3xl text-orange-500 mb-6">
                {t('hero.subtitle')}
              </h2>
            </div>
